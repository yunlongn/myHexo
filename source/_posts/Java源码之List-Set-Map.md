...
![双向链表](https://images-roland.oss-cn-shenzhen.aliyuncs.com//blog/20190524150119.png)

**双向循环链表：** 最后一个节点的 next 指向head，而 head 的prev指向最后一个节点，构成一个环。 

![](https://images-roland.oss-cn-shenzhen.aliyuncs.com//blog/20190524150124.png)
...
> 推荐一个很不错的源码分析文章  **[https://www.javadoop.com/post/hashmap](https://www.javadoop.com/post/hashmap)**
...
[![jdk1.8之前的内部结构](https://images-roland.oss-cn-shenzhen.aliyuncs.com//blog/20190524145912.png)

### JDK1.8之后

相比于之前的版本， JDK1.8之后在解决哈希冲突时有了较大的变化，当链表长度大于阈值（默认为8）时，将链表转化为红黑树，以减少搜索时间。

[![JDK1.8之后的HashMap底层数据结构](https://images-roland.oss-cn-shenzhen.aliyuncs.com//blog/20190524145957.png)
...
HashTable: [![img](https://images-roland.oss-cn-shenzhen.aliyuncs.com//blog/20190524150024.png)

**JDK1.7的ConcurrentHashMap：** [![img](https://images-roland.oss-cn-shenzhen.aliyuncs.com//blog/20190524150311.png)
**JDK1.8的ConcurrentHashMap（TreeBin: 红黑二叉树节点 Node: 链表节点）：** 
[![img](https://images-roland.oss-cn-shenzhen.aliyuncs.com//blog/20190524150258.png)
