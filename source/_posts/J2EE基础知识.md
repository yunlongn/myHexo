...
> 本文引用 [https://github.com/Snailclimb/JavaGuide](https://github.com/Snailclimb/JavaGuide)
> 自己进行了添加与修改
...
![](https://images-roland.oss-cn-shenzhen.aliyuncs.com//blog/20190523091349.png)
...
```
其实Java的底层实现原理就是 （将设置的cookie 用Set-Cookie的方式返回给浏览器）

![](https://images-roland.oss-cn-shenzhen.aliyuncs.com//blog/20190523090908.png)
